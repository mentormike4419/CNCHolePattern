...
int main() {
    ...
    int spindle{ 9000 };
    int feed{ 450 };
    int holes{ 3 }; // max number of holes
    ...
    // while (Hcount <= holes) {
        ...
        // convert while loop to one time for the mk4n end holes
        // std::string fname = ("MK4n" + std::to_string(Hcount) + "_Alum_HolePattern.tap");
        std::string fname = ("MK4n_Alum_HolePattern.tap");
